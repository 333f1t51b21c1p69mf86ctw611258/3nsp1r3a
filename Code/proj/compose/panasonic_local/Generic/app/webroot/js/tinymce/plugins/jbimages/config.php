...
| -------------------------------------------------------------------*/
    ...
    // FIXME if possible - Enspirea
    // internal AJAX request is not handled properly from the specified below
    // specified absolute URL in dialog-v4.html
	$config['img_path'] = '/Generic/app/webroot/images'; // Relative to domain name
	$config['upload_path'] = $_SERVER['DOCUMENT_ROOT'] . '/Generic/app/webroot/images';
