<div class="row">
    <div class="col-sm-3 col-md-3">
        <?php
            ...
            echo $this->WorkflowAppPortal->submenu_left('Administration', $isApprover, $countsPerState, $enableReview, $enableAssignedToBuddy, $reviewOnly, $isPostApprover, $readOnly);
        ?> 
    </div>
